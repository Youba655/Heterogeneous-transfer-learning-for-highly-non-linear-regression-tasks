...
def loss_function(params_array, data, bounds, target_column="N_simul"):
    ...
    # Division by y_true weights errors by magnitude (heteroscedastic loss)
    # This ensures accurate predictions at both low and high nitrogen concentrations
...
class CustomLoss(nn.Module):
    ...
    def forward(self, y_pred, y_true):
        ...
        # Division by y_true creates heteroscedastic weighting
