...
- Full implementations of the proposed methods and their competitors
- Final results stored in `.csv` files
- Generated figures in `.pdf` format

**Not included (due to confidentiality restrictions):**
- ODE solver (uses **LSODE** from the **SLATEC** library)
- Simulated and real datasets
- True kinetic parameter values and their boundaries

---
## Contact
For any questions or collaborations, please contact:  
**Youba Abed** — [youba.abed@ifpen.fr](mailto:youba.abed@ifpen.fr)
